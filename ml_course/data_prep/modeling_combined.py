...
# Explore and prepare the data (Task 0)
LABEL = 'price'
...
print(car_data[numeric_feature_names])  # numeric features
print(car_data[categorical_feature_names])  # categorical features
...
# Make your best model with numeric features (Task 1)
...
model_feature_columns = [
                            ...
                            tf.feature_column.numeric_column(feature_name,
                                                             normalizer_fn=lambda val: (val - x_df.mean()[
                                                                 feature_name]) / (epsilon + x_df.std()[feature_name]))
